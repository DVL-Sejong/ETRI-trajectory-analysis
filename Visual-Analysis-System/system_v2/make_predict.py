...
def predict(amount, e, t):
    df = pd.read_csv('C:/users/skang/trajectory/cabspotting/small-Sanf/usage.csv', index_col='Unnamed: 0')
    node = pd.read_csv('C:/users/skang/trajectory/cabspotting/small-Sanf/SanFrancisco_nodes.csv')
    edge = pd.read_csv('C:/users/skang/trajectory/cabspotting/small-Sanf/SanFrancisco_edges.csv')
